...
function Nosotros(){
    return(
        <>
            <Helmet>
                <title>Nosotros | Homesleep</title>
                <meta name="description" content="Sobre nosotros"/>

                <meta property="og:title" content="Nosotros | Homesleep"/>
                ...
                <div className="block-container">
                    <section className="block-content">
                        <div className="d-flex-column gap-20">
                            <img src="/assets/imagenes/paginas/nosotros/banner.jpg" alt="Nosotros | Homesleep" className="page-banner-img"/>
