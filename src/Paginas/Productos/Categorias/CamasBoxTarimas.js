...
//     useEffect(() => {
//         if (sub4) {
//             const rutaProducto = `/productos/camas-box-tarimas/${sub1}/${sub2}/${sub3}/${sub4}`;
...
//                         url => url.includes(`/camas-box-tarimas/${sub1}/`)
//                     );
//                 }

//                 if (sub2) {
//                     archivosProductos = archivosProductos.filter(
//                         url => url.includes(`/camas-box-tarimas/${sub1}/${sub2}/`)
//                     );
//                 }

//                 if (sub3) {
//                     archivosProductos = archivosProductos.filter(
//                         url => url.includes(`/camas-box-tarimas/${sub1}/${sub2}/${sub3}.json`)
//                     );
//                 }
...
//         if (queryParams.entries().length === 0) return productos;
...
//                         <FiltrosTop setOrden={setOrden} orden={orden} productosCount={productosOrdenados.length} totalProductos={productos.length}/>
