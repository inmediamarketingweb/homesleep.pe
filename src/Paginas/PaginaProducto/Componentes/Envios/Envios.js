...
// //             <div className='destino-select'>
// //                 <input className='destino-input' type='text' placeholder='Ingresa su distrito'></input>
...
//     return(
//         <>
//             <div className='product-page-locations d-flex-column gap-5'>
//                 {/* <p className='title color-color-1 uppercase d-grid-1-1'>Distrito</p> */}

//                 <div className='d-flex-column gap-5'>
//                     {/* <div className='product-page-location-button product-page-location-button-1'>
//                         <span className="material-symbols-outlined">store</span>
//                         <div className='d-flex-column w-100'>
//                             <p className='title color-color-1 margin-right'>En tienda</p>
//                             <p className='text text-left margin-right'>Producto disponible para retiro</p>
//                         </div>
//                     </div> */}

//                     <button className='product-page-location-button product-page-location-button-2 button-1'>
//                         <div>
...
//                     <button className='product-page-location-button product-page-location-button-3 button-1'>
//                         <div>
...
//             <div className='product-page-envios-layer'></div>

//             <div className='product-page-envios-container'>
//                 <div className=''>
//                     {/* <div className='product-page-envios-buttons-select-locations'>
...
//                     <div className='product-page-envios-selected d-flex-column gap-20'>
//                         <div>
//                             <p className='text'>Departamento</p>
//                             <input type='text'></input>

//                             <div className='product-page-envios-selected-options'>
//                                 <ul>
//                                     <li>
//                                         <button type='button'>
