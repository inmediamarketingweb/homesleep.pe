...
function Descripcion({ producto, descripciones }){
    const formatKey = (key) => key.replace(/-/g, ' ');

    // Si tenemos descripciones separadas (nueva estructura)
    ...
    // Si el producto tiene descripción integrada (estructura antigua - para retrocompatibilidad)
