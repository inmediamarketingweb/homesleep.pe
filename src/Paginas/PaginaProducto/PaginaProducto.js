...
//         // Buscar tamaño en el nombre completo del producto
//         const nombreLower = nombreCompleto.toLowerCase();
        
//         // Patrones para identificar tamaños
...
//         console.log('Nombre normalizado para ruta:', nombreNormalizado);
        
//         // Usar el tamaño del producto principal si está disponible
//         let tamaño = tamañoPrincipal;
        
//         // Si no tenemos tamaño del producto principal, intentar extraerlo del nombre del colchón
//         if (!tamaño) {
//             if (/\bking\b/i.test(nombreNormalizado)) {
//                 tamaño = 'king';
...
//         console.log('Tamaño identificado:', tamaño);
//         console.log('Nombre después de quitar tamaño:', nombreNormalizado);
        
//         if (!tamaño) {
//             console.warn('No se pudo identificar el tamaño para el colchón');
//             return null;
//         }
...
//         console.log('Nombre para modelo:', nombreNormalizado);
        
//         // Extraer modelo (limpia el nombre)
...
//         // Extraer tamaño del nombre del producto principal si no se proporcionó
//         let tamañoParaBuscar = tamañoProductoPrincipal;
//         if (!tamañoParaBuscar) {
//             tamañoParaBuscar = extraerTamañoDelNombreProducto(nombreProductoCompleto);
//             console.log('Tamaño extraído del nombre del producto:', tamañoParaBuscar);
//         }
...
//         console.log('Buscando colchón en ruta:', rutaColchon);

//         try {
//             const respuesta = await fetch(rutaColchon);
            
//             if (!respuesta.ok) {
//                 console.warn(`Archivo no encontrado en la ruta: ${rutaColchon} (Status: ${respuesta.status})`);
//                 return null;
//             }
...
//                 console.warn(`La respuesta no es JSON en: ${rutaColchon}`);
//                 return null;
//             }
            
//             const datosColchon = await respuesta.json();
            
//             // Procesar según la estructura de tu JSON
...
//             console.log('Datos procesados del colchón:', {
//                 tieneFicha: fichaColchon.length > 0,
//                 tieneMensajes: mensajesColchon.length > 0,
//                 tieneProducto: !!productoColchon,
//                 regalos: regalosColchon,
//                 tamaño: productoColchon?.tamaño
//             });
...
//         } catch (fetchError) {
//             console.error('Error al obtener el archivo JSON:', fetchError);
//             return null;
//         }
...
//             console.log('=== CARGANDO DESCRIPCIÓN DEL COLCHÓN ===');
//             console.log('Nombre del producto completo:', nombreProducto);
//             console.log('Producto principal:', productoPrincipal);
            
//             setCargandoColchon(true);
//             try {
//                 // Extraer tamaño del producto principal si está disponible
...
//                     console.log('Tamaño del producto principal:', tamañoProducto);
//                 }
                
//                 const descripcion = await obtenerDescripcionColchonDesdeNombre(nombreProducto, tamañoProducto);
//                 console.log('Resultado de búsqueda del colchón:', descripcion ? 'ENCONTRADO' : 'NO ENCONTRADO');
//                 if (!cancelled) {
...
function PaginaProducto(){
    ...
    useEffect(() => {
        ...
        const cargarDescripcionColchon = async (nombreProducto, productoPrincipal) => {
            ...
            console.log('=== CARGANDO DESCRIPCIÓN DEL COLCHÓN ===');
            console.log('Nombre del producto completo:', nombreProducto);
            console.log('Producto principal completo:', productoPrincipal);
            console.log('Tamaño del producto principal:', productoPrincipal?.tamaño);
            ...
            try {
                ...
                if (productoPrincipal && productoPrincipal.tamaño) {
                    tamañoProducto = productoPrincipal.tamaño.toLowerCase().replace(/\s+/g, '-');
                    console.log('Tamaño procesado del producto principal:', tamañoProducto);
                } else {
                    console.log('No se encontró campo "tamaño" en el producto principal');
                }
