...
//                                                     <div className='d-grid-auto-1fr gap-5'>
//                                                         <span class="material-symbols-outlined">delivery_truck_bolt</span>
//                                                         <div className='d-flex-column'>
//                                                             <p className='title color-color-1 uppercase'>LIMA</p>
//                                                             <p className='text'><span className='color-red'>*</span>Envío gratuito y entrega el mismo día</p>
//                                                         </div>
//                                                     </div>
...
//                                                         <div className='d-flex-column'>
//                                                             <p className='title color-color-1 uppercase'>provincia</p>
//                                                             <p className='text'><span className='color-red'>*</span>Envío gratuito y entrega el mismo día</p>
//                                                         </div>
//                                                     </div>
//                                                 </div>
