...
function Cuentas(){
    return(
        <>
            <Helmet>
                <title>Medios de pago | Homesleep</title>
            </Helmet>
                ...
                <div className='block-container'>
                    <section className='block-content'>
                        <div className='block-title-container'>
                            <h1 className='block-title'>Números de cuenta</h1>
                        </div>

                        <div className='d-grid-2-1fr gap-20'>
                            <div className='d-flex w-100'>
                                <img src='/assets/imagenes/paginas/servicio-al-cliente/medios-de-pago/medios-de-pago-2.jpg' alt='Medios de pago | Homesleep' className='w-100 d-flex object-container'/>
                            </div>

                            <div className='d-flex-column gap-10'>
                                <div className='d-flex-column'>
                                    <p className='text font-bold'>1.- Depósitos y transferencias bancarias:</p>
                                ...
                                <div className='d-flex-column'>
                                    <p className='text font-bold'>2.- Tarjeta Visa Débito o Crédito:</p>
                                ...
                                <div className='d-flex-column'>
                                    ...
                                    <p className='text'>Se podrá pagar única y solamente la totalidad de la orden de compra incluyendo el valor del flete. Homesleep no asume ningún tipo de responsabilidad por no contar con el cambio necesario para el cliente.</p>
                                ...
                                <div className='d-flex-column'>
                                    <p className='text font-bold'>4.- Pago en tienda:</p>
                                ...
                                <div className='d-flex-column'>
                                    <p className='text font-bold'>5.- Yape, Plin y otras billeteras:</p>
                                    <p className='text'>Asímismo aceptamos pagos con yape y plim, asumiendo que el cliente conoce que los pagos máximos por día de yape son de 500 soles y de plim de 1500 soles, quedando fuera de nuestra responsabilidad el desconocimiento del cliente para efectos de realizar el pago.</p>
                                </div>
                            </div>
                        </div>
                    </section>
